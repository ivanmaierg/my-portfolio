    ...
    return (
        <Container>
            <InfoContainer initial={{ opacity: 0, x: '-100vw' }} animate={{ opacity: 1, x: '0'}} transition={{type:'spring', stiffness:50}}>
                ...
                <ButtonAction href="#About" whileHover={{ scale: 1.2, originX: 0.3,originY:0, filter:'brightness(1.3)', }} transition={{type:'spring',stiffness:'120'}}><span>About me</span></ButtonAction>
                </InfoContainer>
